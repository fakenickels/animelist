...
class AnimesControllerTest < ActionController::TestCase
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post :create, anime: { description: @anime.description, episodes: @anime.episodes, name: @anime.name, rating: @anime.rating }
    end
  ...
  test "should update anime" do
    patch :update, id: @anime, anime: { description: @anime.description, episodes: @anime.episodes, name: @anime.name, rating: @anime.rating }
    assert_redirected_to anime_path(assigns(:anime))
  end
